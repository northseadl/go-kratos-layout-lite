...
// Validate checks the field values on HiReply with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *HiReply) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on HiReply with the rules defined in the
// proto definition for this message. If any rules are violated, the result is
// a list of violation errors wrapped in HiReplyMultiError, or nil if none found.
func (m *HiReply) ValidateAll() error {
	return m.validate(true)
}

func (m *HiReply) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return HiReplyMultiError(errors)
	}

	return nil
}

// HiReplyMultiError is an error wrapping multiple validation errors returned
// by HiReply.ValidateAll() if the designated constraints aren't met.
type HiReplyMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m HiReplyMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m HiReplyMultiError) AllErrors() []error { return m }

// HiReplyValidationError is the validation error returned by HiReply.Validate
// if the designated constraints aren't met.
type HiReplyValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e HiReplyValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e HiReplyValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e HiReplyValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e HiReplyValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e HiReplyValidationError) ErrorName() string { return "HiReplyValidationError" }

// Error satisfies the builtin error interface
func (e HiReplyValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = HiReplyValidationError{}
