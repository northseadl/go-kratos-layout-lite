...
func (c *helloClient) Hello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/api.hello.v1.Hello/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *helloClient) Hi(ctx context.Context, in *HiRequest, opts ...grpc.CallOption) (*HiReply, error) {
	out := new(HiReply)
	err := c.cc.Invoke(ctx, "/api.hello.v1.Hello/Hi", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedHelloServer) Hi(context.Context, *HiRequest) (*HiReply, error) {
...
func _Hello_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.hello.v1.Hello/Hello",
	}
...
func _Hello_Hi_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.hello.v1.Hello/Hi",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Hello_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.hello.v1.Hello",
